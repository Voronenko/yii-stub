...
//Uncomment if running on environment with externally stored assets
// Make sure your build process collects all required assets on build process.
/*
            'assetManager' => array(
                'class' => 'FSAssetManager',

                'published' => array(
//     Overrides supported, sorry  - for Win Unix deployment for now 2 records.
//  '/framework/web/widgets/pagers/pager.css' => 'style/css/pager.css',
//  '\\framework\\web\\widgets\\pagers\pager.css' => 'style/css/pager.css',
                   '/style/' => 'style/'
                )
            ),
...
*/
          ...
          'fileSystem' => array(
            'class' => 'application.components.FS.Disk_FileSystem',
            'basePath' => '/uploads/'
           ),
